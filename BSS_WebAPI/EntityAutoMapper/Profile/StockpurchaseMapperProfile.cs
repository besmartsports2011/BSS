...
{                                                                                          
    class StockpurchaseMapperProfile : Profile                                                       
    {                                                                                      
        ...
        {                                                                                  
            ...
            CreateMap<Models.DTO.Stockpurchase, BSS_DataAccess.StockPurchase>();                                                         
                                                                                           
            // Reverse Mapping                                                             
            SourceMemberNamingConvention = new MyUpperUnderscoreNamingConvention();        
            DestinationMemberNamingConvention = new PascalCaseNamingConvention();          
            CreateMap<BSS_DataAccess.StockPurchase, Models.DTO.Stockpurchase>();                                                         
